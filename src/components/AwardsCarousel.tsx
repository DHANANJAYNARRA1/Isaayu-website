    ...
    <section className="py-24 bg-gradient-to-br from-slate-50 via-orange-50 to-green-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-100 to-orange-100 text-yellow-600 px-10 py-5 rounded-full font-bold mb-8 text-xl shadow-xl">
        ...
        <div className="relative max-w-6xl mx-auto">
                    ...
                    <div className={`bg-gradient-to-br ${award.bgGradient} rounded-3xl p-4 md:p-12 shadow-2xl border border-white/50 backdrop-blur-sm`}>
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 items-center">
                        ...
                        <div className="lg:order-first">
                          <div className="bg-white/80 backdrop-blur-sm rounded-2xl h-64 md:h-80 flex items-center justify-center shadow-xl border border-white/50 overflow-hidden">
                            {award.image ? (
                              <img 
                                src={award.image} 
                                alt={award.title}
          ...
          <button
            onClick={prevSlide}
            className="absolute left-2 md:left-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white text-slate-600 p-3 md:p-4 rounded-full shadow-xl transition-all duration-300 hover:scale-110 z-10"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-2 md:right-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white text-slate-600 p-3 md:p-4 rounded-full shadow-xl transition-all duration-300 hover:scale-110 z-10"
            ...
            {awards.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 md:w-4 md:h-4 rounded-full transition-all duration-300 ${
                  index === currentSlide 
                    ? 'bg-gradient-to-r from-orange-500 to-green-500 w-6 md:w-8' 
