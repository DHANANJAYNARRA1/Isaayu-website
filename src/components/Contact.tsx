...
const Contact = () => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const whatsappUrl = `https://wa.me/917527866666?text=${encodeURIComponent(message)}`;
  ...
  const handleEmailClick = () => {
    ...
    const mailtoUrl = `mailto:isaayufarms@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    window.open(mailtoUrl);
  };

  const handleCallClick = () => {
    window.open('tel:+917527866666');
  };
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-100">+91 7527866666</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-100">isaayufarms@gmail.com</p>
                    <p className="text-green-100">customercare@isaayu.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-center">
                    <div className="bg-white p-3 rounded-xl">
                      <img 
                        src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://wa.me/917527866666`} 
