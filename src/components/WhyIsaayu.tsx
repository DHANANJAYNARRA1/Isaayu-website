      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl md:text-6xl font-bold mb-8">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-800">The Future of</span><br/>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-600">Urban Farming</span>
          </h2>
          <p className="text-xl md:text-2xl text-slate-700 max-w-4xl mx-auto leading-relaxed mb-12">
            At <span className="text-orange-500 font-semibold">ISAAYU</span>, we're revolutionizing how people grow food in urban environments with smart, 
            sustainable, and incredibly easy-to-use agricultural solutions that make growing your own <span className="text-green-600 font-semibold">fresh, organic food</span> simple, efficient, and enjoyable.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <div key={index} className={`bg-white rounded-3xl shadow-xl p-8 flex flex-col items-center text-center ${index % 2 === 0 ? 'border-t-4 border-b-4 border-orange-400 hover:border-orange-500' : 'border-t-4 border-b-4 border-green-400 hover:border-green-500'} transition-all duration-300 hover:shadow-2xl`}>
              ...
              <h3 className={`text-xl font-bold mb-2 ${index % 2 === 0 ? 'text-orange-600' : 'text-green-600'}`}>{feature.title}</h3>
