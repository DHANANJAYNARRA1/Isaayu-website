...
const ProductShowcase = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      features: ['Weather Resistant', 'Auto Irrigation', 'Advanced IoT Control', 'Custom Design']
    },
    {
      title: 'Smart App Interface',
      description: 'Control and monitor your entire garden from your smartphone',
      image: '/assets/images/agri7.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/hydro3.jpg',
    ...
    },
    {
      ...
      image: '/assets/watermanagement.jpg',
          ...
          {[
            {
              ...
              description: 'Advanced IoT technology implemented for seamless monitoring and control of your garden systems.'
            },
            {
              icon: Leaf,
