  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-4">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-green-600 to-orange-500">ABOUT US</span>
          </h2>
      ...
      <section className="py-12 bg-gradient-to-br from-green-50 to-orange-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-6">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 via-orange-500 to-green-600">The ISAAYU Difference</span>
          </h2>
