...
const PlantDiariesPage = () => {
  const educationalArticles = [
    {
      ...
      date: 'Dec 15, 2024',
      readTime: '5 min read',
      image: 'assets/Spinach-Farming-Guide5.jpg'
    },
    {
  ...
  return (
    <div className="pt-20 bg-gradient-to-b from-green-50 to-orange-50">
      {/* Hero Section */}
      <section className="py-24 bg-gradient-to-b from-green-50 to-orange-50 relative overflow-hidden">
      ...
      <section className="py-24 bg-gradient-to-b from-orange-50 to-green-50">
              ...
              <div key={index} className="bg-gradient-to-r from-green-50 to-orange-50 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-1">
                    <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl h-64 overflow-hidden relative">
                      <img 
                        src={article.image} 
                        alt={article.title}
      ...
      {/* Nutrition Tips */}
      <section className="py-24 bg-gradient-to-b from-green-50 to-orange-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-green-800 mb-6">
