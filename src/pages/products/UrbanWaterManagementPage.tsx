    ...
    <div className="pt-20">
      ...
      <section className="py-24 bg-gradient-to-b from-cyan-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Wifi, title: 'IoT Connectivity', desc: 'Advanced IoT technology for remote monitoring and control' },
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="w-full max-w-3xl mx-auto mt-4">
              <AppDownload variant="full" productName="Urban Water Management" animationDelay={500} />
            </div>
          </div>
        </div>
