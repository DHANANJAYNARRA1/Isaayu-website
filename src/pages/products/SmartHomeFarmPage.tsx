...
const SmartHomeFarmPage: React.FC<SmartHomeFarmPageProps> = ({ setCurrentPage }) => {
  ...
  const features = [
    ...
    'Technology Used: Advanced IoT Technology',
    'With soil-based and soilless options',
    'IoT Based Automated Water Management System',
    'User friendly interface'
  ];

  const benefits = [
    'Harvests: Access fresh, nutritious, flavorful homegrown produce',
    'Water Efficiency: Up to 90% water savings compared to traditional farming',
    'Energy Efficient: Minimal electricity consumption with smart power management',
    'Space Optimization: Maximizes yield in limited urban spaces',
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="mt-6 w-full max-w-md">
              <AppDownload variant="full" productName="Smart Home Farm" animationDelay={500} />
            </div>
          </div>
        </div>
