...
const Agri360Page: React.FC<Agri360PageProps> = ({ setCurrentPage }) => {
  ...
  const benefits = [
    ...
    'Resource Optimization: Up to 95% water savings, minimal electricity consumption, and optimal space utilization',
    'Drone Technology: Aerial monitoring, crop assessment, and precision application of inputs',
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="w-full max-w-3xl mx-auto mt-4">
              <AppDownload variant="full" productName="Agri360" animationDelay={500} />
            </div>
          </div>
        </div>
