  ...
  <div className="pt-20">
    ...
    <section className="py-16 bg-white border-t border-gray-100">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl font-bold text-green-800 mb-6">Track Your Installation Progress</h2>
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          Download our app to monitor your installation status, access setup guides, and get instant support.
        </p>
        <div className="w-full max-w-md mx-auto">
          <AppDownload variant="full" productName="Installation & Setup" animationDelay={500} />
        </div>
      </div>
    </section>
  </div>
