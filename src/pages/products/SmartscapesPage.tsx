...
const SmartscapesPage: React.FC<SmartscapesPageProps> = ({ setCurrentPage }) => {
  ...
  const benefits = [
    'Water Conservation: Up to 95% water savings with precision irrigation',
    'Energy Efficiency: Solar-powered options with minimal electricity usage',
    'Space Optimization: Maximizes landscape potential with smart zoning',
    'Remote Monitoring and Control: Manage your landscape from anywhere',
    'Increased Efficiency: Automated scheduling and resource allocation',
    'Improved Plant Health: Optimal growing conditions for all vegetation',
    'Environmental Impact: Reduced water waste and chemical runoff',
    'Reduced Labor: Minimizes manual intervention requirements',
    'Data-Driven Insights: Analytics for continuous improvement',
    'Early Problem Detection: Alerts for system issues or plant health concerns',
    'Easy Adaptability: Flexible system that grows with your needs',
    'Cost Savings: Reduced water bills and maintenance expenses'
  ];
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="w-full max-w-3xl mx-auto mt-4">
              <AppDownload variant="full" productName="Smartscapes" animationDelay={500} />
            </div>
          </div>
        </div>
