...
const GrowYourGreensPage: React.FC<GrowYourGreensPageProps> = ({ setCurrentPage }) => {
  ...
  const features = [
    ...
    'IoT Based Automated Nutrient Management',
    'User Friendly interface',
    'Technology Used: IoT Technology',
    'Easy Assembly',
    'Optimal Light Management System',
  ...
  const benefits = [
    ...
    'Optimal usage of water with up to 90% water savings',
    'Energy-efficient system with minimal electricity consumption',
    'Maximizes space utilization for urban environments',
      ...
      <section className="py-24 bg-gradient-to-b from-emerald-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Wifi, title: 'IoT Connectivity', desc: 'Advanced IoT technology for remote monitoring' },
              { icon: Lightbulb, title: 'Light Management', desc: 'Optimal lighting system for plant growth' },
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="w-full max-w-3xl mx-auto mt-4">
              <AppDownload variant="full" productName="Grow Your Greens" animationDelay={500} />
            </div>
          </div>
        </div>
