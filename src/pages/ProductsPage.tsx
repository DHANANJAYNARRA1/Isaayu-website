...
const ProductsPage: React.FC<ProductsPageProps> = ({ setCurrentPage }) => {
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-orange-50 via-green-50 to-orange-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12 md:mb-20">
            ...
            <h1 className="text-2xl md:text-5xl lg:text-7xl font-semibold mb-4 md:mb-8 leading-tight">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-600">SMART</span> <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-800">HOME FARM</span><br/>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-600">GROW</span> <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-800">YOUR GREENS</span><br/>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-600">URBAN</span> <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-800">WATER MANAGEMENT</span><br/>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-600">SMARTSCAPES</span><br/>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-600">AGRI</span><span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-800">360</span>
            </h1>
            <p className="text-base md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Discover our complete range of <span className="text-orange-500 font-semibold">smart farming products</span> designed to revolutionize 
              urban agriculture with cutting-edge <span className="text-green-600 font-semibold">IoT technology</span> and automation for a sustainable future.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-orange-600 via-green-700 to-orange-600">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
